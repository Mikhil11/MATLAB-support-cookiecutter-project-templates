% testMathFunctions - Example MATLAB Unit Test for a Toolbox
...
%       runtests testMathFunctions/testAddFunc
%       runtests testMathFunctions/testSubtractFunc
%   - For running complete test file use:
%       runtests testMathFunctions
...
function tests = testMathFunctions
